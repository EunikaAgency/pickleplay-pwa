      ...
      <div>
        ...
        <div className="content-section">
          ...
          <ul className="settings-list">
            ...
            {userHasPermission(user, 'user.messages.send') && (
              <li className="settings-item" role="button" tabIndex={0} onClick={() => onNavigate('messages')}>
                ...
                <div className="settings-label">
                  ...
                  <span>Chat with players &amp; venues</span>
                </div>
                <Chevron />
              </li>
            )}
            ...
            <li className="settings-item" role="button" tabIndex={0} onClick={() => onNavigate('social', { tab: 'friends' })}>
              <div className="settings-icon">
            ...
            <li className="settings-item" role="button" tabIndex={0} onClick={() => onNavigate('members')}>
              <div className="settings-icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M22 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>
              </div>
              <div className="settings-label">
                <strong>Members</strong>
                <span>Your community &amp; memberships</span>
              </div>
              <Chevron />
            </li>
