...
import coachBookingsRoutes from '../features/coach-bookings/coach-bookings.routes.js';
import partnerSubscriptionsRoutes from '../features/partner-subscriptions/partner-subscriptions.routes.js';
...
v1.route('/coach-bookings', coachBookingsRoutes);
v1.route('/partner-subscriptions', partnerSubscriptionsRoutes);
